...
def run_demo(cfg, ckpt, score_threshold, images_dir, output_dir, dataset_type):
    ...
    print('{}: {}'.format( image_name, meters))

    drawn_image = draw_boxes(image, boxes, labels, scores, class_names).astype(np.uint8)
    ################修改
    Image.fromarray(drawn_image).save("result保存绝对路径/文件名"+".jpg")
...
def main():
    ...
    parser.add_argument("--ckpt", type=str, default="outputs/resnet50_ssd300_voc0712_feature_fusion/model_006000.pth", help="Trained weights.")
