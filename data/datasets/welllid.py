...
class welllidDataset(torch.utils.data.Dataset):
    class_names = ('__background__','broke', 'circle', 'good', 'lose','uncovered')

    def __init__(self, data_dir, split, transform=None, target_transform=None, keep_difficult=False):
        """Dataset for welllid data.
        Args:
            data_dir: the root of the welllid, the directory contains the following sub-directories:
        ...
        self.ids = welllidDataset._read_image_ids(image_sets_file)
    ...
    def _get_annotation(self, image_id):
        ...
        for obj in objects:
            ...
            # welllid dataset format follows Matlab, in which indexes start from 0
