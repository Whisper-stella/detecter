...
from .eval_detection_welllid import eval_detection_welllid


def welllid_evaluation(dataset, predictions, output_dir, iteration=None):
    ...
    result = eval_detection_welllid(pred_bboxes=pred_boxes_list,
