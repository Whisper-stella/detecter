from ssd.data.datasets import VOCDataset, COCODataset,welllidDataset

from .coco import coco_evaluation
from .voc import voc_evaluation
from .welllid import welllid_evaluation 
...
def evaluate(dataset, predictions, output_dir, **kwargs):
    ...
    elif isinstance(dataset, welllidDataset):
        return welllid_evaluation(**args)
